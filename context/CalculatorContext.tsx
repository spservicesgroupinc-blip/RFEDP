...
// --- TYPES ---
type ViewType = 'calculator' | 'settings' | 'profile' | 'warehouse' | 'estimate' | 'dashboard' | 'customers' | 'customer_detail' | 'work_order_stage' | 'invoice_stage' | 'estimate_stage' | 'material_report' | 'estimate_detail';
    ...
    case 'RESET_CALCULATOR':
      return {
        ...
        appData: {
          ...
          inventory: [], jobNotes: '', scheduledDate: '', invoiceDate: '', 
