    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in zoom-in duration-200 pb-20">
          <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-4 gap-2">
             <div>
                ...
                <p className="text-slate-500 font-medium text-sm">Manage chemicals and supplies.</p>
             </div>
         </div>
                 ...
                 <div className="bg-white p-5 md:p-8 rounded-3xl border shadow-sm border-slate-200 md:col-span-2">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                         ...
                         <div className="bg-red-50 rounded-2xl p-4 md:bg-transparent md:p-0 border border-red-100 md:border-none">
                             ...
                             <div className="flex items-center bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden shadow-inner group focus-within:ring-2 focus-within:ring-brand/20 transition-all">
                                <button 
                                    onClick={() => onStockChange('openCellSets', (state.warehouse.openCellSets || 0) - 0.25)} 
                                    className="w-12 h-16 flex items-center justify-center hover:bg-slate-100 border-r border-slate-200 text-slate-400 hover:text-brand transition-colors active:bg-slate-200"
                                >
                                ...
                                <input 
                                    ...
                                    className={`flex-1 h-16 bg-transparent text-center font-black text-3xl outline-none ${state.warehouse.openCellSets < 0 ? 'text-red-600' : 'text-slate-900'}`} 
                                />
                                <button 
                                    onClick={() => onStockChange('openCellSets', (state.warehouse.openCellSets || 0) + 0.25)} 
                                    className="w-12 h-16 flex items-center justify-center hover:bg-slate-100 border-l border-slate-200 text-slate-400 hover:text-brand transition-colors active:bg-slate-200"
                                >
                                    <span className="text-2xl font-light">+</span>
                                </button>
                             </div>
                         ...
                         <div className="bg-red-50 rounded-2xl p-4 md:bg-transparent md:p-0 border border-red-100 md:border-none">
                             ...
                             <div className="flex items-center bg-slate-50 rounded-2xl border border-slate-200 overflow-hidden shadow-inner group focus-within:ring-2 focus-within:ring-brand/20 transition-all">
                                <button 
                                    onClick={() => onStockChange('closedCellSets', (state.warehouse.closedCellSets || 0) - 0.25)} 
                                    className="w-12 h-16 flex items-center justify-center hover:bg-slate-100 border-r border-slate-200 text-slate-400 hover:text-brand transition-colors active:bg-slate-200"
                                >
                                    <span className="text-2xl font-light">-</span>
                                </button>
                                <input 
                                    ...
                                    className={`flex-1 h-16 bg-transparent text-center font-black text-3xl outline-none ${state.warehouse.closedCellSets < 0 ? 'text-red-600' : 'text-slate-900'}`} 
                                />
                                <button 
                                    onClick={() => onStockChange('closedCellSets', (state.warehouse.closedCellSets || 0) + 0.25)} 
                                    className="w-12 h-16 flex items-center justify-center hover:bg-slate-100 border-l border-slate-200 text-slate-400 hover:text-brand transition-colors active:bg-slate-200"
